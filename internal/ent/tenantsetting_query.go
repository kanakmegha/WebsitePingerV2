...
func (tsq *TenantSettingQuery) QueryTenant() *TenantQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(tenantsetting.Table, tenantsetting.FieldID, selector),
...
func (tsq *TenantSettingQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (tsq *TenantSettingQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (tsq *TenantSettingQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (tsq *TenantSettingQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (tsq *TenantSettingQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (tsq *TenantSettingQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := tsq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tsq *TenantSettingQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(tenantsetting.Table, tenantsetting.Columns, sqlgraph.NewFieldSpec(tenantsetting.FieldID, field.TypeUUID))
	_spec.From = tsq.sql
	...
	if fields := tsq.ctx.Fields; len(fields) > 0 {
		...
		if tsq.withTenant != nil {
			_spec.Node.AddColumnOnce(tenantsetting.FieldTenantID)
		}
	}
