...
const (
	// Label holds the string label denoting the sslcheckresult type in the database.
	Label = "ssl_check_result"
	...
	EdgeCheck = "check"
	// Table holds the table name of the sslcheckresult in the database.
	Table = "ssl_check_results"
	// CheckTable is the table that holds the check relation/edge.
	CheckTable = "ssl_check_results"
...
// Columns holds all SQL columns for sslcheckresult fields.
var Columns = []string{
	FieldID,
	FieldCheckID,
	FieldExpiryDate,
...
// OrderOption defines the ordering options for the SSLCheckResult queries.
